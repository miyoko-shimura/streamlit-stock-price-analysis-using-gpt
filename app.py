...
if st.button('Analyze'):
    if not ticker:
        ...
        try:
            ...
            1. ## Summary
               Provide a brief overview of the stock's performance and potential. NOt use the numbers to prevent error. Add space between numbers and letters. Add space after period.
